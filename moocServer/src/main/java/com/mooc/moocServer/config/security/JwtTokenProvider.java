...
public class JwtTokenProvider {
    ...
    private Long tokenValidMillisecond = 1000L * 60 * 60; // 60s * 60 = 1h

    private final MemberService memberService;

    // object initializing with Base64 encoding secret key.
    @PostConstruct
    protected void init() {
    ...
    public String createToken(String userPk, List<String> roles) {
        ...
        return Jwts.builder()
                ...
                .setIssuedAt(now) // 토큰 발행시각
                .setExpiration(new Date(now.getTime() + tokenValidMillisecond)) // 유효시간
    ...
    // Request header 에서 token 파싱 : "X-AUTH-TOKEN : jwt 토큰"
